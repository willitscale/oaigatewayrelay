 ...
 * 
 * 	Table 13: 
 * 		Feature_Status_Masks
 * 
 * 		BIT# 	HEX 		FEATURE 							LOGICAL 	DEFAULT 
 * 																NUMBER 		FEATURE 
 * 																			CODE (US)
 ...
 * 
 * 	EXAMPLES: 
 * 		Keyset 1001 enables the handsfree feature.
 ...
 */
public class FeatureStatus extends Feature
{
	public final static String EVENT = "FE";
	
	public FeatureStatus( String event )
	{
		super( event );
	}

	public FeatureStatus( String[] eventParts )
	{
		super( eventParts );
	}

	protected int mExtension;
	protected int mLogicalNumber;
	protected int mOnOff;
	
	public FeatureStatus setExtension( int extension )
	{
	...
	public FeatureStatus setLogicalNumber( int logicalNumber )
	{
		this.mLogicalNumber = logicalNumber;
		return this;
	}
	
	public int getLogicalNumber()
	{
		return this.mLogicalNumber;
	}
	
	public FeatureStatus setOnOff( int onOff )
	{
		this.mOnOff = onOff;
		return this;
	}

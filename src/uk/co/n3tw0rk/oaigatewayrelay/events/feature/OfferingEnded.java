...
USE: Occurs when offering control is terminated at the device (see page 71 for information about the
...
NOTES: The following items apply to the Offering Ended event:
...
always blank.
SYNTAX: OE,<Resync_Code>,<Mon_Cross_Ref_ID>,<Affected_Ext>,
<Reason><CR><LF>
Where:
...
EXAMPLES: The application exceeded the allowed number of failures.
006,OE,,<MON100>,100,4
Device monitor was stopped via the _MP command.
010,OE,,<MON100>,100,0

 */
public class OfferingEnded {

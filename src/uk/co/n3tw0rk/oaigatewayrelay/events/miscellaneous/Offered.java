 ...
 * @since 05-03-2015
 * 
 * @see SYSTEM OAI SPECIFICATIONS MANUAL – Issue 9.0, April 2005 - Page 71
 * 
 * OFFERED – OF
 * 
 * 	NOTE: 
 ...
 * 
 * 	USE: 
 * 		Allows an application to redirect calls that arrive at a specific station (keyset or single-line)
 ...
 * 
 * 	NOTE: 
 * 		To avoid conflict and a potentially unpredictable situation, two applications should never
 * 		attempt to control the same type of calls at the same device.
 * 	
 * 	ALSO: 
 * 		The system allows station users to disable offering control (routing). To disable this
 ...
 * 	
 * 	NOTES: 
 * 		The following information applies to the Offered event:
 ...
 *
 *	SYNTAX: 
 *		OF,<Resync_Code>,<Mon_Cross_Ref_ID >,<Call_ID>,
 ...
 */
public class Offered extends Miscellaneous
{
	...
	protected int mLocalCnxState;
	protected int mEventCause;
	protected int mHuntGroupID;
	
	public Offered( String eventParts )
	{
		super( eventParts );
	}

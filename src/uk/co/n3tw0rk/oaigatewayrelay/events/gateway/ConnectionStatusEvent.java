...
NOTE: This event applies to Gateway V2.0 and later only.
USE: Informs connecting applications that the specified phone system node is not connected to the
...
SYNTAX: CS,<Resync_Code>,<Connection_Number>,<Connection_State>,<Previous_Node
_Number>,<Current_Node_Number><CR><LF>
Where:
...
— If the CT Gateway was never able to communicate with this node, this field is left
blank.
...
EXAMPLES: Connection 3 failed. The Gateway does not yet know the node number.
CS,,3,0,

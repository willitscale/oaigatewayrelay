...
USE: Provides the current mode of every ACD/UCD agent who is a member of the specified ACD/
UCD hunt group.
PREMIUM FEATURE: Third-Party Call Control
SYNTAX: _QH,<InvokeID>,<Affected_Ext><CR>
Where the valid device type for <Affected_Ext> is an ACD or UCD hunt group pilot number.
CONFIRMATION: <Sequence_Number>,CF,_QH,<InvokeID>,<Outcome>,<Number_of_Entries>,
...
NOTE: Extension lists are not counted individually, however, each extension in the list
...
hunt group pilot.
DESKTOP OAI: None
EXAMPLE: Agent 100 is logged into ACD group 261 at extension 200 and is ready to receive calls, and
Agent 101 is logged out of hunt group 261.
_QH,<InvokeID>,261
001,CF,_QH,<InvokeID>,0,1,100,200,1,101,,0

 */
public class QueryHuntGroup {

...
USE: Allows an application to indicate that it will not re-route an offered call and that the call will
...
(07.00 < V <
08.10):
_AOC,<InvokeID>,<Affected_Ext>,<Call_ID>,
<Prohibit_Immediate_Connect><CR>
SYNTAX
(V >= 08.10):
_AOC,<InvokeID>,<Affected_Ext>,<Call_ID>,
<Prohibit_Immediate_Connect>,<Override_DND><CR>
Where:
...
NOTE: This parameter does not override DND or forward settings.
...
NOTE: Calls accepted at a device that has handsfree enabled and is in DND do not
come in handsfree. This is the same way that DND override works when requested via
a feature code.
CONFIRMATION: <Sequence_Number>,CF,_AOC,<InvokeID>,<Outcome>,<Affected_Ext>,
<Call_ID><CR><LF>
COMMON FAILURE
OUTCOME VALUES:
...
EXAMPLES: The application indicates that the phone system should deliver the call.
_AOC,245,100,*01
 ...
 */
public class AcceptOfferedCall {

...
CHANGE TIMER – _CT
USE: Changes a telephone system timer value. Currently this command supports changing the Unsupervised
...
NOTE: This command will fail unless every node in the entire telephone system network supports
...
SYNTAX: _CT,<InvokeID>,<Affected_Ext>,<Call_ID>,<Timer>,<New_Duration><CR>
Where:
...
before timing out.
CONFIRMATION: <Sequence_Number>,CF,_CT,<InvokeID>,<Outcome><CR><LF>
COMMON FAILURE
OUTCOME VALUES:
...
DESKTOP OAI: None
GATEWAY IMPACTS: If an application sends this command to a node whose protocol is V06.00 or later, the CT Gateway
...
EXAMPLE: A CT application wants to change the Unsupervised CO timer for trunk-to-trunk call 201 to

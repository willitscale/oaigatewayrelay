...
/**
 * <strong>Cancel Callback Class</strong>
 * 
 * @author James Lockhart <james@n3tw0rk.co.uk>
 * @version 1.0
 * @since 04-02-2015
 * 
 * @see SYSTEM OAI SPECIFICATIONS MANUAL – Issue 9.0, April 2005 - Page 94
 * 
 * 	CANCEL CALLBACK – _CCB
 * 
 * 	NOTE: 
 * 		This command is available only in protocol versions 08.10 and later.
 * 	
 * 	USE: 
 * 		Cancels a callback request. The <Affected_Ext> must have previously requested a callback,
 ...
 * 
 * 	SYNTAX: 
 * 		_CCB,<InvokeID>,<Affected_Ext>,<Target_Ext><CR>
 * 
 * 	Where:
 ...
 * 	
 * 	CONFIRMATION: 
 * 		<Sequence_Number>,CF,_CCB,<InvokeID>,<Outcome><CR><LF>
 * 
 ...
 * 
 */
public class CancelCallback extends AffectedExt
{
	public static final String COMMAND = "_CCB";
	
	protected int mTargetExt;
	
	public Command setTargetExt( int targetExt )
	{

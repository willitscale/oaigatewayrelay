...
USE: Provides important information about the characteristics of the station display.
PREMIUM FEATURE: Third-Party Call Control
SYNTAX: _DQD,<InvokeID>,<Affected_Ext><CR>
Where valid device types for <Affected_Ext> include stations with displays.
CONFIRMATION: <Sequence_Number>,CF,_DQD,<InvokeID>,<Outcome>,<Display_Model>,
...
DESKTOP OAI: None
EXAMPLES: Query the display for extension 100, which has a display model of 0, is using the primary

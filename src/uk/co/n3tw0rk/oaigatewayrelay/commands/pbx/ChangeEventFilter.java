...
USE: Changes the event filters associated with a monitor. Typically a monitor is started by the user
...
invalid flags.
DESKTOP OAI: None
EXAMPLES: Disable all events on monitor 100.
 ...
 */
public class ChangeEventFilter {
